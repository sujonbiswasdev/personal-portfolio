...
<footer className="bg-neutral-primary-soft text-white">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="/" className="flex items-center">
                  <img src="/photos/sujon_logo.png" className="h-7 me-3" alt="sujon biswas" />
                  <span className="text-heading self-center text-2xl font-semibold whitespace-nowrap">sujon</span>
              </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  ...
                  <ul className="text-body font-medium">
                      <li className="mb-4">
                          <a href="https://github.com/sujonbiswasdev" className="hover:underline ">Github</a>
                      </li>
                  </ul>
              </div>
              <div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-body sm:text-center">© 2025 <a href="/" className="hover:underline">sujon biswas</a>. All Rights Reserved.
          </span>
